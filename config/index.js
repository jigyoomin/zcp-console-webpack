...
const RULEs = [
  ...
  {regx: path2regx('/api/cluster/:cs/namespace/list'), val: `/api/user/${username}/resource/namespace`},
  {regx: path2regx('/api/resource/:tail*'), val: (exec, req) => `/api/user/${username}/resource/namespace/${req.query.ns}/${exec[1] + exec[2]}`}
